const mssql_config = {
    user: process.env.APPSETTING_mssql_username, // better stored in an app setting such as process.env.DB_USER
    password: process.APPSETTING_env.mssql_password, // better stored in an app setting such as process.env.DB_PASSWORD
